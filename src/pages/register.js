    ...
    render () {
        return(
            <Container className="container d-flex justify-content-center align-items-center">
                ...
                <Card.Header className="card-header bg-info text-white text-center"><strong>REGISTER</strong></Card.Header>
                <Card.Body>
                    { !this.state.logged ? 
                        (
                    ...
                    <p class="fw-bolder">Jika Sudah Punya Akun, Lakukan LOGIN!</p>
                    <Link to='/login'><Button variant="info" type="submit">Login</Button></Link>
                    </Form>
                </Card.Body>
                </Card>
            </Container>
